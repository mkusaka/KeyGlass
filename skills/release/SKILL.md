...
name: release
description: >-
  Repository-scoped release instructions for KeyGlass. Use this when the user
...
allowed-tools:
  ...
  - Glob
metadata:
  short-description: Tag-driven release workflow for KeyGlass
---
...
- `KeyGlass.zip` is attached to the GitHub Release
